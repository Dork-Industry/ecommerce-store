        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="linkbar-1">
            ...
            <div class="collapse navbar-collapse" id="-navbarSupportedContent">
                <ul class="navbar-nav ml-auto navbar" id="navmenu-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="login.html" id="link-474">Login</a> 
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Register.html" id="link-474">Register</a> 
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <section id="trend">
            ...
            <div class="controls row">
                <div class="col-md-3" id="column-130">
                    <a href="Product_Detail.php" id="linkblock-147"><img src="img/644bfbdb07795_1682701275.jpeg"></a> <a href="#" id="link-937">View More</a>
                    <p>
                        <b>GOLD PENDANT</b>
                    </p><a href="Product_Detail.php" id="link-133">View More</a> 
                </div>
                <div class="col-md-3" id="column-149">
                    <a href="Product_Detail.php" id="linkblock-150"><img src="img/644bfbdb37c1c_1682701275.jpeg"></a> <a href="#" id="link-938">View More</a>
                    <p>
                        <strong>GOLD CHUR</strong>
                    </p><a href="Product_Detail.php" id="link-153">View More</a> 
                </div>
                <div class="col-md-3" id="column-154">
                    <a href="Product_Detail.php" id="linkblock-155"><img src="img/644bfbd023505_1682701264.jpeg"></a> <a href="#" id="link-939">View More</a>
                    <p>
                        <strong>GOLD EARINGS</strong>
                    </p><a href="Product_Detail.php" id="link-158">View More</a> 
                </div>
                <div class="col-md-3" id="column-159">
                    <a href="Product_Detail.php" id="linkblock-160"><img src="img/644bfbcff0639_1682701263.jpeg"></a> <a href="#" id="link-940">View More</a>
                    <p>
                        <strong>GOLD G RINGS</strong>
                    </p><a href="Product_Detail.php" id="link-163">View More</a> 
                </div>
            </div>
        </section>
